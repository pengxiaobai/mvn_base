 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://first.demo.com/", wsdlLocation = "http://127.0.0.1:8899/User?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://first.demo.com/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8899/User?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://first.demo.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://first.demo.com/", "UserServiceImplPort"), UserService.class, features);
    }
